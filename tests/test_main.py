# filepath: /Users/Peters/workspace/b64tool/tests/test_main.py
"""
Unit tests for b64tool module.

This module contains tests for the Base64 encoding and decoding functionality.
"""
import unittest
import os
...
class TestBase64Functions(unittest.TestCase):
    ...
    def test_encode_text(self):
        """Test encoding specific text to known Base64 values."""
        test_cases = [
